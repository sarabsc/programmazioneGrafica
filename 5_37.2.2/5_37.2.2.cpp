...
#include <C:\Users\utente\source\repos\triangolo\shader_5.h>
#include <C:\Users\utente\source\repos\triangolo\camera.h>
#include <C:\Users\utente\source\repos\triangolo\model.h>
...
int main()
{
    ...
    // shaders
    Shader shader("5_37.2.2_normal_mapping.vs", "5_37.2.2_normal_mapping.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, glm::radians((float)glfwGetTime() * -10.0f), glm::normalize(glm::vec3(1.0, 0.0, 1.0))); // ruota il quad per mostrare il normal mapping da direzioni multiple
        ...
        // // render della luce (un piano più piccolo)
        model = glm::mat4(1.0f);
...
void renderQuad()
{
    if (quadVAO == 0)
    {
        ...
        // calcola i vettori tangente e bitangente di entrambi i triangoli
...
unsigned int loadTexture(char const* path)
{
    ...
    if (data)
    {
        ...
        // in questo caso si usa GL_CLAMP_TO_EDGE per prevenire i bordi semi trasparenti
        // A causa dell'interpolazione prende i texels dalla ripetizione successiva
