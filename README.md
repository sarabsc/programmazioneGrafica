...
File 1_4.4
![File 1_4.4](https://github.com/sarabsc/programmazioneGrafica/blob/main/media/1_4.4.png)
...
File 1_10.9_1 (camera.h con ground level (xz plane))
...
 
13.7 Esercizio 2: Implementa il Pong shading nello spazio view invece che world
