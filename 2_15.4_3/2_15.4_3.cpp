...
int main()
{
    ...
    // shaders
    Shader lightingShader("2_15.4_3_lighting_maps.vs", "2_15.4_3_lighting_maps.fs");
    Shader lightCubeShader("2_15.4_3_light_cube.vs", "2_15.4_3_light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // proprietà della luce (tutte impostate alla massima intensità)
