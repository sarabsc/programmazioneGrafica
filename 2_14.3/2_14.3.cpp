...
int main()
{
    ...
    // shaders
    Shader lightingShader("2_14.3_materials.vs", "2_14.3_materials.fs");
    Shader lightCubeShader("2_14.3_light_cube.vs", "2_14.3_light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 diffuseColor = lightColor * glm::vec3(0.5f); // riduce l'influenza della luce diffusa
        glm::vec3 ambientColor = diffuseColor * glm::vec3(0.2f); // abbassa l'influenza della luce ambientale
        ...
        lightingShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f); // la luce speculare non ha pieno effetto su questo materiale
        ...
        model = glm::scale(model, glm::vec3(0.2f)); // più piccolo dell'altro cubo
